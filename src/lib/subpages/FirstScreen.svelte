                    ...
                    <div class="flex flex-col md:flex-row mb-2 h-full md:justify-center md:space-x-2 space-y-2 md:space-y-0">
                        <div class="flex flex-col md:w-2/3 lg:w-1/2 h-full space-y-2">
                            ...
                            <div class="bg-[#005630] md:rounded-3xl bg-opacity-60 hover:bg-opacity-90 p-3 flex flex-col justify-center">
                                ...
                                <div class="font-semibold">
                                    I'm Adithiya Venkatakrishnan, but I go as Venky with friends and atomtables
                                    online.
                                    <br><br>
                                    I'm a high school sophomore passionate about the world of software
                                    development, cybersecurity, and
                                    general computer science. Scroll down to see my projects!
                                    <br><br>
                                    I've been coding since I was about seven years old, and my main interests
                                    lie in the fields of mobile app development, web development and low-level
                                    programming.
                                    <br><br>
                                    I play the piano and sing, and I really like music (I'm working on some
                                    stuff right now).
                                    <br><br>
                                    I go to Edison Academy Magnet School, and I'm on the Computer Science Club
                                    Council there. I also write articles for the Eagle Eye, the school newspaper, especially for the Tech topics.
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col w-full md:w-1/3 lg:w-1/2 space-y-2">
                            ...
                            <IObserver element={organisations} bind:intersecting={organisationsIO} once>
                                <div class="bg-[#001220] md:rounded-3xl bg-opacity-60 p-5 flex flex-col justify-center w-full" bind:this={organisations}>
                                    <div>
                                        Organisations
                                    </div>
                                    {#if organisationsIO}
